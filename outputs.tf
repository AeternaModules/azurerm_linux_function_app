output "linux_function_apps_id" {
  description = "Map of id values across all linux_function_apps, keyed the same as var.linux_function_apps"
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.id if v.id != null && length(v.id) > 0 }
}
output "linux_function_apps_app_settings" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.app_settings if v.app_settings != null && length(v.app_settings) > 0 }
}
...
output "linux_function_apps_builtin_logging_enabled" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.builtin_logging_enabled if v.builtin_logging_enabled != null }
}
output "linux_function_apps_client_certificate_enabled" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.client_certificate_enabled if v.client_certificate_enabled != null }
}
output "linux_function_apps_client_certificate_exclusion_paths" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.client_certificate_exclusion_paths if v.client_certificate_exclusion_paths != null && length(v.client_certificate_exclusion_paths) > 0 }
}
output "linux_function_apps_client_certificate_mode" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.client_certificate_mode if v.client_certificate_mode != null && length(v.client_certificate_mode) > 0 }
}
output "linux_function_apps_connection_string" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.connection_string if v.connection_string != null && length(v.connection_string) > 0 }
  sensitive   = true
}
output "linux_function_apps_content_share_force_disabled" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.content_share_force_disabled if v.content_share_force_disabled != null }
}
output "linux_function_apps_custom_domain_verification_id" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.custom_domain_verification_id if v.custom_domain_verification_id != null && length(v.custom_domain_verification_id) > 0 }
  sensitive   = true
}
output "linux_function_apps_daily_memory_time_quota" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.daily_memory_time_quota if v.daily_memory_time_quota != null }
}
output "linux_function_apps_default_hostname" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.default_hostname if v.default_hostname != null && length(v.default_hostname) > 0 }
}
output "linux_function_apps_enabled" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.enabled if v.enabled != null }
}
output "linux_function_apps_ftp_publish_basic_authentication_enabled" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.ftp_publish_basic_authentication_enabled if v.ftp_publish_basic_authentication_enabled != null }
}
output "linux_function_apps_functions_extension_version" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.functions_extension_version if v.functions_extension_version != null && length(v.functions_extension_version) > 0 }
}
output "linux_function_apps_hosting_environment_id" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.hosting_environment_id if v.hosting_environment_id != null && length(v.hosting_environment_id) > 0 }
}
output "linux_function_apps_https_only" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.https_only if v.https_only != null }
}
...
output "linux_function_apps_key_vault_reference_identity_id" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.key_vault_reference_identity_id if v.key_vault_reference_identity_id != null && length(v.key_vault_reference_identity_id) > 0 }
}
output "linux_function_apps_kind" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.kind if v.kind != null && length(v.kind) > 0 }
}
output "linux_function_apps_location" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.location if v.location != null && length(v.location) > 0 }
}
output "linux_function_apps_name" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.name if v.name != null && length(v.name) > 0 }
}
output "linux_function_apps_outbound_ip_address_list" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.outbound_ip_address_list if v.outbound_ip_address_list != null && length(v.outbound_ip_address_list) > 0 }
}
output "linux_function_apps_outbound_ip_addresses" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.outbound_ip_addresses if v.outbound_ip_addresses != null && length(v.outbound_ip_addresses) > 0 }
}
output "linux_function_apps_possible_outbound_ip_address_list" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.possible_outbound_ip_address_list if v.possible_outbound_ip_address_list != null && length(v.possible_outbound_ip_address_list) > 0 }
}
output "linux_function_apps_possible_outbound_ip_addresses" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.possible_outbound_ip_addresses if v.possible_outbound_ip_addresses != null && length(v.possible_outbound_ip_addresses) > 0 }
}
output "linux_function_apps_public_network_access_enabled" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.public_network_access_enabled if v.public_network_access_enabled != null }
}
output "linux_function_apps_resource_group_name" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "linux_function_apps_service_plan_id" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.service_plan_id if v.service_plan_id != null && length(v.service_plan_id) > 0 }
}
...
output "linux_function_apps_site_credential" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.site_credential if v.site_credential != null && length(v.site_credential) > 0 }
  sensitive   = true
}
...
output "linux_function_apps_storage_account" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.storage_account if v.storage_account != null && length(v.storage_account) > 0 }
  sensitive   = true
}
output "linux_function_apps_storage_account_access_key" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.storage_account_access_key if v.storage_account_access_key != null && length(v.storage_account_access_key) > 0 }
  sensitive   = true
}
output "linux_function_apps_storage_account_name" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.storage_account_name if v.storage_account_name != null && length(v.storage_account_name) > 0 }
}
output "linux_function_apps_storage_key_vault_secret_id" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.storage_key_vault_secret_id if v.storage_key_vault_secret_id != null && length(v.storage_key_vault_secret_id) > 0 }
}
output "linux_function_apps_storage_uses_managed_identity" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.storage_uses_managed_identity if v.storage_uses_managed_identity != null }
}
output "linux_function_apps_tags" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.tags if v.tags != null && length(v.tags) > 0 }
}
output "linux_function_apps_virtual_network_backup_restore_enabled" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.virtual_network_backup_restore_enabled if v.virtual_network_backup_restore_enabled != null }
}
output "linux_function_apps_virtual_network_subnet_id" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.virtual_network_subnet_id if v.virtual_network_subnet_id != null && length(v.virtual_network_subnet_id) > 0 }
}
output "linux_function_apps_vnet_image_pull_enabled" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.vnet_image_pull_enabled if v.vnet_image_pull_enabled != null }
}
output "linux_function_apps_webdeploy_publish_basic_authentication_enabled" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.webdeploy_publish_basic_authentication_enabled if v.webdeploy_publish_basic_authentication_enabled != null }
}
output "linux_function_apps_zip_deploy_file" {
  ...
  value       = { for k, v in azurerm_linux_function_app.linux_function_apps : k => v.zip_deploy_file if v.zip_deploy_file != null && length(v.zip_deploy_file) > 0 }
}
